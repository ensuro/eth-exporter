...
Welcome to `blockchain-exporter` contributor's guide.
...
If you experience bugs or general issues with `blockchain-exporter`, please have a look
...
You can help improve `blockchain-exporter` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`blockchain-exporter` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `blockchain-exporter`'s files. While this mechanism can
...
```
conda create -n blockchain-exporter python=3 six virtualenv pytest pytest-cov
conda activate blockchain-exporter
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/blockchain-exporter.git
...
5. Install [pre-commit]:
   ...
   `blockchain-exporter` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/blockchain-exporter
[issue tracker]: https://github.com/<USERNAME>/blockchain-exporter/issues
